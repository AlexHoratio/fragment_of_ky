...
func next_stage() -> void:
	...
	match text_stage:
		...
		1:
			add_new_text("[color=#ffb629]I made all this, for A [shake level=50]SINGLE GOLD COIN?![/shake]")
			target_position = Vector2(150, 50)
		2:
			add_new_text("")
			target_position = Vector2(150 + target_size.x/2.0, 50)
			
			orteil.walk_to(Vector2(1673, 995))
			orteil.queue_dialogue_after_walk("Calm down.", true, 1, 2, "nf1_end_calm_down", 2)
		_:
			print("UHH")
